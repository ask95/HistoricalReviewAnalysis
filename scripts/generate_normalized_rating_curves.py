...
#TODO: Change all the variable names which are copied from generate_normalized_polarity.py
...
for j in range(len(file_list)):
    ...
    for i in range(len(data)):
        ...
        polarity = data[i]['Ratings']['Overall']
        polarity_monthly_list[str(date_object.month) + ', ' + str(date_object.year)] += float(polarity)
    ...
    with open('/home/meet/sentiment-analysis/normalized_ratings/normalized_rating_' + str(file_list[j]),
              'w') as outfile:
