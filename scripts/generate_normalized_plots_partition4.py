...
with open('/Users/anikeshkamath/Documents/sentiment-analysis/csv/RatingCluster5_withSentiCluster.csv', mode='r') as infile:
    reader = csv.reader(infile)
    mydict = dict((rows[0],rows[1]) for rows in reader)


for j in range(len(file_list)):
    with open('/Users/anikeshkamath/Documents/sentiment-analysis/normalized_polarity/' + str(file_list[j])) as f:
