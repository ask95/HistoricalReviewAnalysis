...
with open('/home/meet/sentiment-analysis/csv/RatingCluster5_withSentiCluster.csv', mode='r') as infile:
...
file_writer(dic_cluster1, '/home/meet/sentiment-analysis/results/partition_5_bigrams_cluster1.csv')
file_writer(dic_cluster2, '/home/meet/sentiment-analysis/results/partition_5_bigrams_cluster2.csv')
file_writer(dic_cluster3, '/home/meet/sentiment-analysis/results/partition_5_bigrams_cluster3.csv')
